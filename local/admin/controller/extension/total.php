...
class ControllerExtensionTotal extends Controller {
	public function index() {
		...
		foreach ($extensions as $key => $value) {
			...
			if (!file_exists(DIR_LOCAL_APPLICATION . 'controller/total/' . $value . '.php')) {
		...
		$local_files = glob(DIR_LOCAL_APPLICATION . 'controller/total/*.php');
	...
	public function install() {
		...
		if (!$this->user->hasPermission('modify', 'extension/total')) {
			...
			if (file_exists(DIR_LOCAL_APPLICATION . 'controller/total/' . $this->request->get['extension'] . '.php'))
			{
				require_once(DIR_LOCAL_APPLICATION . 'controller/totsl/' . $this->request->get['extension'] . '.php');
			}
			else
			{
