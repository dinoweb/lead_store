...
class ControllerExtensionPayment extends Controller {
	public function index() {
		...
		foreach ($extensions as $key => $value) {
			if (!file_exists(DIR_APPLICATION . 'controller/payment/' . $value . '.php')) {
				if (!file_exists(DIR_LOCAL_APPLICATION . 'controller/payment/' . $value . '.php')) {
		...
		$local_files = glob(DIR_LOCAL_APPLICATION . 'controller/payment/*.php');
	...
	public function install() {
		...
		if (!$this->user->hasPermission('modify', 'extension/payment')) {
			...
			if (file_exists(DIR_LOCAL_APPLICATION . 'controller/payment/' . $this->request->get['extension'] . '.php'))
			{
				require_once(DIR_LOCAL_APPLICATION . 'controller/payment/' . $this->request->get['extension'] . '.php');
			}
			else
			{
