...
class ControllerExtensionShipping extends Controller {
	public function index() {
		...
		foreach ($extensions as $key => $value) {
			if (!file_exists(DIR_APPLICATION . 'controller/shipping/' . $value . '.php')) {
				if (!file_exists(DIR_LOCAL_APPLICATION . 'controller/shipping/' . $value . '.php')) {
		...
		$local_files = glob(DIR_LOCAL_APPLICATION . 'controller/shipping/*.php');
	...
	public function install() {
		...
		if (!$this->user->hasPermission('modify', 'extension/shipping')) {
			...
			if (file_exists(DIR_LOCAL_APPLICATION . 'controller/shipping/' . $this->request->get['extension'] . '.php'))
			{
				require_once(DIR_LOCAL_APPLICATION . 'controller/shipping/' . $this->request->get['extension'] . '.php');
			}
			else
			{
