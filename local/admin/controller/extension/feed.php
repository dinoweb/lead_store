...
class ControllerExtensionFeed extends Controller {
	public function index() {
		...
		foreach ($extensions as $key => $value) {
			if (!file_exists(DIR_APPLICATION . 'controller/feed/' . $value . '.php')) {
				if (!file_exists(DIR_LOCAL_APPLICATION . 'controller/feed/' . $value . '.php')) {
		...
		$local_files = glob(DIR_LOCAL_APPLICATION . 'controller/feed/*.php');
	...
	public function install() {
    	...
    	if (!$this->user->hasPermission('modify', 'extension/feed')) {
			...
			if (file_exists(DIR_LOCAL_APPLICATION . 'controller/feed/' . $this->request->get['extension'] . '.php'))
			{
				require_once(DIR_LOCAL_APPLICATION . 'controller/feed/' . $this->request->get['extension'] . '.php');
			}
			else
			{
