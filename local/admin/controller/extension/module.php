...
class ControllerExtensionModule extends Controller {
	public function index() {
		...
		foreach ($extensions as $key => $value) {
			if (!file_exists(DIR_APPLICATION . 'controller/module/' . $value . '.php')) {
				if (!file_exists(DIR_LOCAL_APPLICATION . 'controller/module/' . $value . '.php')) {
		...
		$local_files = glob(DIR_LOCAL_APPLICATION . 'controller/module/*.php');
	...
	public function install() {
		...
		if (!$this->user->hasPermission('modify', 'extension/module')) {
			...
			if (file_exists(DIR_LOCAL_APPLICATION . 'controller/module/' . $this->request->get['extension'] . '.php'))
			{
				require_once(DIR_LOCAL_APPLICATION . 'controller/module/' . $this->request->get['extension'] . '.php');
			}
			else
			{
